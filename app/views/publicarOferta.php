...
<head>
    ...
    <title>BuscoBrete - Publicar Empleo</title>
    ...
    <link
        ...
        rel="stylesheet">
    <!-- Script de publicarOferta -->
    <script src="<?= BASE_URL ?>/public/js/publicarOferta.js"></script>
        ...
        <div class="container" style="max-width: 700px;">
            ...
            <div class="card border-0 shadow-sm p-4">
                ...
                <div class="d-flex gap-3">
                    <button id="btnPublicar" class="btn btn-success px-4" type="button">
                        Publicar
                    </button>
